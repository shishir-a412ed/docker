...
func (r *router) initRoutes() {
	r.routes = []dkrouter.Route{
		...
		NewGetRoute("/containers/{name:.*}/diff", r.getContainersDiff),
		NewGetRoute("/containers/{name:.*}/metadata", r.getContainersMetadata),
		...
		NewPostRoute("/containers/diff", r.postContainersDiff),
		NewPostRoute("/containers/metadata", r.postContainersMetadata),
